...
export default [
  ...
  },
  {
    ...
    end: new Date(2024, 8, 12, 13, 0, 0, 0),
    desc: "Power lunch"
  },
  {
    id: 8,
  ...
  },
  {
    ...
    end: new Date(2024, 8, 12, 17, 30, 0, 0),
  ...
  },
  {
    ...
    end: new Date(2024, 8, 13, 10, 30, 0)
  },
  {
    id: 11.1,
    title: "Inconvenient Conference Call",
    start: new Date(2024, 8, 13, 9, 30, 0),
    end: new Date(2024, 8, 13, 12, 0, 0)
  },
  {
    id: 11.2,
    title: "Project Kickoff - Lou's Shoes",
    start: new Date(2024, 8, 13, 11, 30, 0),
    end: new Date(2024, 8, 13, 14, 0, 0)
  },
  {
    id: 11.3,
    title: "Quote Follow-up - Tea by Tina",
    start: new Date(2024, 8, 13, 15, 30, 0),
    end: new Date(2024, 8, 13, 16, 0, 0)
  },
  {
    id: 12,
    title: "Late Night Event",
    start: new Date(2024, 8, 17, 19, 30, 0),
  ...
  },
  {
    ...
    start: new Date(2024, 8, 17, 19, 30, 0),
    end: new Date(2024, 8, 17, 23, 30, 0)
  },
  {
    id: 13,
    title: "Multi-day Event",
    start: new Date(2024, 8, 20, 19, 30, 0),
  ...
  },
  {
    id: 16,
    title: "Video Record",
    start: new Date(2024, 8, 14, 15, 30, 0),
    end: new Date(2024, 8, 14, 19, 0, 0)
  },
  {
    id: 17,
    title: "Dutch Song Producing",
    start: new Date(2024, 8, 14, 16, 30, 0),
  ...
  },
  {
    ...
    start: new Date(2024, 8, 14, 16, 30, 0),
    end: new Date(2024, 8, 14, 17, 30, 0)
  },
  {
    id: 19,
    title: "Online Coding Test",
    start: new Date(2024, 8, 14, 17, 30, 0),
    end: new Date(2024, 8, 14, 20, 30, 0)
  },
  {
    id: 20,
    title: "An overlapped Event",
    start: new Date(2024, 8, 14, 17, 0, 0),
  ...
  },
  {
    id: 23,
    title: "Go to the gym",
    start: new Date(2024, 8, 14, 18, 30, 0),
    end: new Date(2024, 8, 14, 20, 0, 0)
  }
];
